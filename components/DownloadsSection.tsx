        ...
        <div className="section-divider">
          <div className="min-w-0">
            ...
            <h2 className="mt-2 inline-flex items-center gap-2 font-display text-3xl md:text-4xl">
              <FileText size={22} className="text-[#ff8f62]" />
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {DOWNLOADS.map((d) => (
            ...
            >
              ...
              <span className="inline-flex items-center justify-center rounded-full bg-[#d7222a] px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-white">
                {d.cta}
              </span>
            </a>
          ))}
