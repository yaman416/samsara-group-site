...
// Handy lookup for fixtures by id (used by table + results)
...
// Results for the league table and match results
// Week 1 – 3 included
export const RESULTS: Result[] = [
  ...
  // Week 3 (from your corrected list)
  { fixtureId: "R3-M2", homeGoals: 3, awayGoals: 2 }, // CNFC 3-2 Unity Stars
...
// Old table type and helper still exported (safe to keep)
