...
export default function PartnersPage() {
  return (
    <SiteLayout activeNav="partners">
      ...
      {/* Title sponsor */}
      <section style={{ background: "#f4f4f1", padding: "56px 0 0" }}>
        <div style={{ maxWidth: 1340, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ background: "#fff", border: "1px solid rgba(17,24,39,.10)", borderRadius: 20, overflow: "hidden", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))" }}>
            <div style={{ padding: "clamp(36px,5vw,60px)", display: "flex", flexDirection: "column", justifyContent: "center", gap: 26 }}>
              ...
              <p style={{ margin: 0, fontSize: 17, lineHeight: 1.72, color: "#4a545f", maxWidth: "46ch" }}>
                Naming partner of the Samsara Premier League and presenter of the $4,000 champions prize.
              </p>
            </div>
      ...
      {/* Partner CTA */}
      <section style={{ background: "#f4f4f1", padding: "72px 0 104px" }}>
        <div style={{ maxWidth: 1340, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ background: "#e2372b", color: "#fff", borderRadius: 20, padding: "clamp(36px,5vw,60px)", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 36, alignItems: "center" }}>
